...
namespace Parse.FrontEnd.AJ.Sdts.Datas
{
    ...
    public class AJReferenceRecord<T>
    {
        public AJReferenceRecord(T defineField, ReferenceInfo referenceInfo)
        {
        ...
        {
            return obj is AJReferenceRecord<T> record &&
    ...
    {
        public ReferenceInfo(AJNode referenceNode)
        {
            ReferenceNode = referenceNode;
        }

        public ReferenceInfo(AJNode referenceNode, ExprNode value)
        {
            ReferenceNode = referenceNode;
            Value = value;
        }

        public AJNode ReferenceNode { get; private set; }
