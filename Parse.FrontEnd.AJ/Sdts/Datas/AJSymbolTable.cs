...
namespace Parse.FrontEnd.AJ.Sdts.Datas
{
    ...
    public class AJSymbolTable : SymbolTable
    {
        public AJSymbolTable Base { get; }
        ...
        ///         ...
        /// </summary>
        public AJReferenceTable<ISymbolData> Nodes { get; } = new AJReferenceTable<ISymbolData>();
        ...
        public int BaseCount
        {
            get
            {
                ...
                AJSymbolTable baseTable = this.Base;
        ...
        public IEnumerable<VarTable> AllVarTable
        {
            get
            {
                ...
                AJSymbolTable currentTable = this;
        ...
        public AJSymbolTable(AJSymbolTable @base = null)
        {
            Base = @base;
        }
