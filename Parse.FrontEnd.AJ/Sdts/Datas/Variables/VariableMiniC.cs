...
namespace Parse.FrontEnd.AJ.Sdts.Datas.Variables
{
    ...
    public abstract class VariableMiniC : IDeclareVarExpression, ISymbolData
    {
        protected VariableMiniC(Access accessType, 
                                            AJTypeInfo typeDatas, TokenData nameToken, 
                                            ...
                                            int blockLevel, int offset, IExprExpression initialExpr)
        {
            ...
            if(initialExpr == null) InitialExpr = new DefaultExprData(AJTypeConverter.ToStdDataType(DataType));
    ...
    {
        public ValueVarMiniC(Access accessType, AJTypeInfo typeDatas, TokenData nameToken,
                                        TokenData levelToken, TokenData dimensionToken,
