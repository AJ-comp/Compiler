...
namespace Parse.RegularGrammar
{
    public class NonTerminal : Symbol, IEnumerable<NonTerminalSingle>, ICloneable
    {
        ...
        private NonTerminalAlter Children = new NonTerminalAlter();
        ...
        public void Add(NonTerminalSingle singleNT) => this.Children.Add(singleNT.ToNonTerminalConcat());
        public void Add(NonTerminalConcat symbols) => this.Children.Add(symbols);
        public void Add(params Symbol[] symbols) => this.Children.Add(new NonTerminalConcat(symbols));
        ...
        public void UnionWith(IEnumerable<NonTerminalConcat> other) => this.Children.UnionWith(other);

        public NonTerminalConcat ElementAt(int index) => this.Children.ElementAt(index);
        ...
        {
            this.Children.Clear();
            this.Children.Add(new NonTerminalConcat(0, item));
        }
        ...
        public void Replace(NonTerminal from, NonTerminal to, SymbolSet breakSet = null)
        {
            ...
            foreach(var concat in temp.Children)
            {
