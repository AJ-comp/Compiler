...
namespace ParsingLibrary.Utilities
{
    public class Analyzer
    {
        ...
        private static SymbolSet FindNextSymbolSet(NonTerminal nonTerminal, NonTerminal findSymbol)
        {
            ...
            foreach (NonTerminalSingle singleNT in nonTerminal)
            {
                ...
                foreach (var symbol in singleNT)
                {
                    ...
                    else if (symbol.uniqueKey == findSymbol.uniqueKey) bFind = true;
                }
            }
        ...
        /// <remarks>https://www.lucidchart.com/documents/edit/515ff26b-2649-4150-86ec-80288ef51570/0?beaconFlowId=67B120E7DA8E4FC0</remarks>
        /// <returns></returns>
