...
namespace ParsingLibrary.Grammars
{
    public class AJGrammar : Grammar
    {
        ...
        public AJGrammar()
        {
            this.namespaceStatement.SetItem(@namespace + @identifier + Quantifier.ZeroOrMore(dot + @identifier) + @openCurlyBrace + classStatement + @closeCurlyBrace);
            this.classStatement.SetItem(Quantifier.Optional(accessor) + @class + @identifier + @openCurlyBrace + Quantifier.ZeroOrMore(enumStatement | varStatement | funcStatement) + @closeCurlyBrace);
            this.enumStatement.SetItem(Quantifier.Optional(accessor) + @enum + @identifier + @openCurlyBrace + Quantifier.ZeroOrMore(@identifier + Quantifier.ZeroOrMore(@replace + @digit)) + @closeCurlyBrace);
