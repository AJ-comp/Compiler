...
[発展コース](parse-table-build.md)にあります。ここでは表が指示するとおりについていってみましょう。）
...
（[ひと目で見るパイプライン](the-big-picture.md)で約束した *「掛け算が足し算より先にまとまる」* がまさに
これです。）
...
<pre class="lrbox">
   ...
   └─ <span class="nt">Term</span>            ← a * a がここに一かたまりで!
      ├─ <span class="nt">Term</span>
      │  └─ <span class="nt">Factor</span>
      │     └─ <span class="setm">a</span>
      ├─ <span class="setm">*</span>
