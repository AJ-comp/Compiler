...
본문에서 쭉 쓴 `Expr` 문법은 ε(사라지는 비단말)이 없어서, 규칙 중 일부는 *실제로 돌아가는 모습* 을 못 봤어요. 그래서 여기선 **ε 이 들어간 문법** 들로, *쉬운 것부터 난도를 조금씩 높여* 풀어볼게요. 손으로 같이 따라오면 제일 좋아요.
