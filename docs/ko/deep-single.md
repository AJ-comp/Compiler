...
<pre class="lrbox">
   [ <span class="nt">Expr</span> ] · [ <span class="setm">'+'</span> ] · [ <span class="nt">Term</span> ]      ← NonTerminalConcat (순서만 담은 리스트)
</pre>
...
<pre class="lrbox">
   ...
   NonTerminalSingle
     ...
     └ (RHS — Concat 상속)  [ <span class="nt">Expr</span> ] · [ <span class="setm">'+'</span> ] · [ <span class="nt">Term</span> ]
</pre>
...
<pre class="lrbox">
   Single        :  <span class="nt">Expr</span> -> <span class="nt">Expr</span> <span class="setm">'+'</span> <span class="nt">Term</span>          ("생성규칙" 그 자체)
   여기에 점을 찍으면 →  <span class="nt">Expr</span> -> <span class="nt">Expr</span> <span class="setm">'+'</span> • <span class="nt">Term</span>     ("LR 아이템")
</pre>
