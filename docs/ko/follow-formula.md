...
<pre class="lrbox">
   <span class="nt">Expr</span> → <span class="nt">Expr</span> <span class="setm">'+'</span> <span class="nt">Term</span>      앞쪽 <span class="nt">Expr</span> 바로 뒤 :  <span class="setm">'+'</span>
...
<pre class="lrbox">
   <span class="nt">Term</span> → <span class="nt">Term</span> <span class="setm">'*'</span> <span class="nt">Factor</span>    앞쪽 <span class="nt">Term</span> 바로 뒤 :  <span class="setm">'*'</span>           →  <span class="setm">'*'</span> 추가
