...
<pre class="lrbox">
   <span class="nt">Expr</span> → <span class="nt">Expr</span> <span class="setm">'+'</span> <span class="nt">Term</span>      앞 <span class="nt">Expr</span> 뒤 β = "<span class="setm">'+'</span> <span class="nt">Term</span>"  →  FIRST = <span class="setm">'+'</span>   →  FOLLOW(<span class="nt">Expr</span>) ⊇ { <span class="setm">'+'</span> }
   ...
   <span class="nt">Term</span> → <span class="nt">Term</span> <span class="setm">'*'</span> <span class="nt">Factor</span>    앞 <span class="nt">Term</span> 뒤 β = "<span class="setm">'*'</span> <span class="nt">Factor</span>" →  FIRST = <span class="setm">'*'</span>   →  FOLLOW(<span class="nt">Term</span>) ⊇ { <span class="setm">'*'</span> }
</pre>
...
<pre class="lrbox">
   ...
   α, β = 기호 묶음 <span style="opacity:.6">(B 앞·뒤 토막 — 단말·비단말 섞여도, 없어도 됨)</span>
</pre>
