...
namespace Parse.FrontEnd.Parsers.LR
{
    public class SLRParser : LRParser
    {
        ...
        public override event EventHandler<ParsingUnit> ActionSuccessed;
        public override event EventHandler<ParsingUnit> ReduceAction;
        ...
        /// <returns></returns>
        public override SuccessedKind RecoveryBlockParsing(ParsingBlock parsingBlock, IReadOnlyList<ParsingRecoveryData> recoveryTokenInfos)
        {
            SuccessedKind result = SuccessedKind.NotApplicable;
        ...
        public override SuccessedKind BlockParsing(ParsingBlock parsingBlock, bool bFromLastNext = true)
        {
            SuccessedKind result = SuccessedKind.NotApplicable;
