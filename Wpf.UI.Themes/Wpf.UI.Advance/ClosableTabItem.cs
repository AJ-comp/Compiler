...
namespace Wpf.UI.Advance
{
    ...
    /// 추가합니다.
    ///
    ///     xmlns:MyNamespace="clr-namespace:Wpf.UI.Advance"
    ///
    ///
    ...
    /// 추가합니다.
    ///
    ///     xmlns:MyNamespace="clr-namespace:Wpf.UI.Advance;assembly=Wpf.UI.Advance"
    ///
    ...
    public class ClosableTabItem : TabItem
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            Button button = Template.FindName("PART_CloseButton", this) as Button;
            if (button == null) return;

            this.closeButton = button;
            this.closeButton.Click += (s, e) =>
            {
                var parent = VisualTreeHelper.GetParent(this.closeButton);
