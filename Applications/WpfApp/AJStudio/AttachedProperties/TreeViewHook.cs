...
namespace ApplicationLayer.WpfApp.AttachedProperties
{
    ...
    {
        public static bool GetEnableGotFocusHook(DependencyObject obj) => (bool)obj.GetValue(EnableGotFocusHookProperty);
        public static void SetEnableGotFocusHook(DependencyObject obj, bool value) => obj.SetValue(EnableGotFocusHookProperty, value);
        ...
        public static ICommand GetGotFocusCommand(DependencyObject obj) => (ICommand)obj.GetValue(GotFocusCommandProperty);
        public static void SetGotFocusCommand(DependencyObject obj, ICommand value) => obj.SetValue(GotFocusCommandProperty, value);
        ...
        public static object GetGotFocusCommandParameter(DependencyObject obj) => (object)obj.GetValue(GotFocusCommandParameterProperty);
        public static void SetGotFocusCommandParameter(DependencyObject obj, object value) => obj.SetValue(GotFocusCommandParameterProperty, value);
