...
{
    public class UnloadProject : Command
    {
        public UnloadProject(string name, string description = null) : base(name, description)
        {
        ...
        private int Process(string projPathWithFile, string solutionFullPath)
        {
            return this.Execute(() =>
            {
                ...
                solution.ProjectPaths.Remove(new PathModel(pathInfo.GetPath()));
